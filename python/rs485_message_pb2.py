...
_sym_db.RegisterEnumDescriptor(_RS485_TYPE)
...
_sym_db.RegisterEnumDescriptor(_RS485_SENSOR)
...
Rs485 = _reflection.GeneratedProtocolMessageType('Rs485', (_message.Message,), dict(
  DESCRIPTOR = _RS485,
  __module__ = 'rs485_message_pb2'
  # @@protoc_insertion_point(class_scope:Rs485)
  ))
_sym_db.RegisterMessage(Rs485)

OwData = _reflection.GeneratedProtocolMessageType('OwData', (_message.Message,), dict(
  DESCRIPTOR = _OWDATA,
  __module__ = 'rs485_message_pb2'
  # @@protoc_insertion_point(class_scope:OwData)
  ))
_sym_db.RegisterMessage(OwData)

AnalogData = _reflection.GeneratedProtocolMessageType('AnalogData', (_message.Message,), dict(
  DESCRIPTOR = _ANALOGDATA,
  __module__ = 'rs485_message_pb2'
  # @@protoc_insertion_point(class_scope:AnalogData)
  ))
_sym_db.RegisterMessage(AnalogData)

TempAccelData = _reflection.GeneratedProtocolMessageType('TempAccelData', (_message.Message,), dict(
  DESCRIPTOR = _TEMPACCELDATA,
  __module__ = 'rs485_message_pb2'
  # @@protoc_insertion_point(class_scope:TempAccelData)
  ))
_sym_db.RegisterMessage(TempAccelData)
